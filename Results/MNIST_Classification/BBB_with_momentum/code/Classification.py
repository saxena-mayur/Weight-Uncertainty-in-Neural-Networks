...
if __name__ == '__main__':
    classify(MODEL='bbb', HIDDEN_UNITS=400, TRAIN_EPOCHS=600, DATASET='mnist', momentum = 0.95)
    classify(MODEL='bbb', HIDDEN_UNITS=800, TRAIN_EPOCHS=600, DATASET='mnist', momentum = 0.95)
    classify(MODEL='bbb', HIDDEN_UNITS=1200, TRAIN_EPOCHS=600, DATASET='mnist', momentum = 0.95)